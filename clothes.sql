...
-- MySQL dump 10.13  Distribute 8.0.15, for Win64 (x86_64)
--
...
LOCK TABLES `tbl_clothes` WRITE;
/*!40000 ALTER TABLE `tbl_clothes`
    DISABLE KEYS */;
/*!40000 ALTER TABLE `tbl_clothes`
    ENABLE KEYS */;
UNLOCK TABLES;
...
(
    ...
    `m_id`          int(11)     NOT NULL COMMENT '衣服编号',
    ...
    CONSTRAINT `tbl_order_detail_ibfk_1` FOREIGN KEY (`m_id`) REFERENCES `tbl_clothes` (`id`),
